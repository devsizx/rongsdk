...
public class FileUtils {
	 ...
	 * 
	 *<p>存储对象</p><br/>
	 *<p>将一个实现了{@link java.io.Serializable}的对象 序列化存储到指定路径中</p>
	 * @since 1.0.0
	 * @author xiaodong
	 * @param object 被存储的对象
	 * @param path 对象被存储的路径
	 ...
	 *
	 *<p>获取对象</p><br/>
	 *<p>根据指定路径 获取到路径存储了实现{@link java.io.Serializable}的对象</p>
	 * @since 1.0.0
	 * @author xiaodong
	 * @param path 对象被存储的路径
	 * @return T 需要被获取的对象
	...
	public static void delete(String path) {
		...
		File file = new File(path);
		if (file.exists()) {
			System.out.println("delete-->" + path + ";state-->" + file.delete());
		}
